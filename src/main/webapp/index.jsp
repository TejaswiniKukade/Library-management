			...
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<div class="row">
							<a href="View_Details.jsp?bid=<%=b2.getBookid() %>" class="btn btn-success btn-sm ml-5">View Detail</a> <a
                       ...
                       Categories:
						...
						<div class="row">
							<a href="" class="btn btn-danger btn-sm ml-2">Add Cart</a> <a
								href="View_Details.jsp?bid=<%=b2.getBookid() %>" class="btn btn-success btn-sm ml-1">View Detail</a> <a
								href="" class="btn btn-danger btn-sm ml-1"><%=b2.getPrice()%>
								<i class="fa-solid fa-indian-rupee-sign"></i></a>
						</div>
			...
			<div class="col-md-3">
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<div class="row">
							<a href="" class="btn btn-danger btn-sm ml-2">Add Cart</a> <a
								href="View_Details.jsp?bid=<%=b.getBookid() %>" class="btn btn-success btn-sm ml-1">View Detail</a> <a
				...
				<div class="card crd-ho">
					<div class="card-body text-center">
						...
						<div class="row">
							...
							<a href="View_Details.jsp?bid=<%=b3.getBookid() %>" class="btn btn-success btn-sm ml-5">View Detail</a> <a
